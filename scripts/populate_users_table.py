...
category_sets = {
    "nature" : [5, 6, 10, 7],
    "culture": [1, 2, 8],
    "religion_and_history": [3, 4],
    "fun": [9, 12, 13],
}

category_sets_descriptions = {
    "nature" : [
...
def create_random_users(glove_model, db, num_users=500):
    ...
    category_set_names = list(category_sets.keys())
    ...
    for i in range(num_users):
        ...
        chosen_set_name = random.choice(category_set_names)
        selected_categories = category_sets[chosen_set_name]
        description_of_interests = random.choice(category_sets_descriptions[chosen_set_name])
